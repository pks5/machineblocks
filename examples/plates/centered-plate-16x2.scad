/**
* MachineBlocks
* https://machineblocks.com/examples/plates
*
* Centered Plate 16x2
...
studShift = "xy"; // [none:None, x:X-Direction, y:Y-Direction, xy:Both Directions]
// Type of the studs
