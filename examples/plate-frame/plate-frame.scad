...
//Back
block(grid=[14,1], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE", holesX=true);
block(grid=[1,1], brickOffset=[-7.5,0,0], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE");

//Outer Wall
block(grid=[14,1], brickOffset=[0,1,0], sideAdjustment=[0,0,0,0], baseLayers=4, baseCutoutType = "NONE", holesX=true, knobs=false);
...
//Left
block(grid=[1,14], brickOffset=[-7.5,-7.5,0], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE", holesY=true);
block(grid=[1,1], brickOffset=[-7.5,-15,0], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE");

//Outer Wall
block(grid=[1,14], brickOffset=[-8.5,-7.5,0], sideAdjustment=[0,0,0,0], baseLayers=4, baseCutoutType = "NONE", holesY=true, knobs=false);
...
//Front
block(grid=[14,1], brickOffset=[0,-15,0], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE", holesX=true);
block(grid=[1,1], brickOffset=[7.5,-15,0], sideAdjustment=[0,0,0,0], baseLayers=3, baseCutoutType = "NONE");
