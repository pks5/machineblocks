...
translate([10, -10, 0]) machineblock(
    size=[8, 2, 1],
...
translate([10, -30, 0]) machineblock(
    size=[10, 2, 1],
    baseCutoutType=baseCutoutType,
    studs=knobs,
    studCentered=knobCentered,
...
translate([10, -50, 0]) machineblock(
    size=[12, 2, 1],
    baseCutoutType=baseCutoutType,
    studs=knobs,
    studCentered=knobCentered,
...
translate([10, -70, 0]) machineblock(
    size=[16, 2, 1],
    baseCutoutType=baseCutoutType,
    studs=knobs,
    studCentered=knobCentered,
...
translate([10, -90, 0]) machineblock(
    size=[20, 2, 1],
    baseCutoutType=baseCutoutType,
    studs=knobs,
    studCentered=knobCentered,
