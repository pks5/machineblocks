...
translate([-26, -20, 0]) machineblock(
    size=[6, 2, 3],
    align="start",
    holeX=true,
...
translate([-26, -40, 0]) machineblock(
    size=[4, 2, 3],
    align="start",
    holeX=true,
    baseCutoutType=baseCutoutType,
...
translate([-26, -60, 0]) machineblock(
    size=[2, 2, 3],
    align="start",
    holeX=true,
    baseCutoutType=baseCutoutType,
...
translate([108, -110, 0]) rotate([0, 0, 180]) {
    ...
    translate([0, -100, 0]) machineblock(
        size=[8, 1, 3],
        align="start",
        holeX=true,
        studType="technic",
    ...
    translate([0, -120, 0]) machineblock(
        size=[16, 1, 3],
        align="start",
        holeX=true,
        studType="technic",
